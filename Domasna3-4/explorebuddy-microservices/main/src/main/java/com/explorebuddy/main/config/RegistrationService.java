...
import com.explorebuddy.main.config.email.EmailService;
import com.explorebuddy.main.config.email.EmailValidator;
import com.explorebuddy.main.config.email.Mail;
...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        ConfirmationToken confirmationToken=webClientBuilder.build()
                .get().uri("http://APPUSER/getConfirmationToken?token="+token)
                .retrieve().bodyToMono(ConfirmationToken.class).block();
...
//                        new IllegalStateException("token not found"));
        ...
        webClientBuilder.build()
                .get().uri("http://APPUSER/setConfirmedToken?token="+token)
                .retrieve().bodyToMono(int.class).block();
